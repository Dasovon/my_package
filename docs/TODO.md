...
- [x] Research hoverboard UART protocol
- [x] Wire controller to Raspberry Pi (GPIO with L298N driver)
...
- [x] Keyboard teleop node for testing

### Safety Features
- [x] Velocity limits (max linear, max angular)
- [x] Acceleration limits (PWM ramping)
- [x] Timeout watchdog (stop if no commands for 1s)
- [x] GPIO permission validation
- [x] Encoder tick sanity checking
